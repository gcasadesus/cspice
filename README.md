[![Actions Status](https://github.com/gcasadesus/cspice/workflows/MacOS/badge.svg)](https://github.com/gcasadesus/cspice/actions)
[![Actions Status](https://github.com/gcasadesus/cspice/workflows/Windows/badge.svg)](https://github.com/gcasadesus/cspice/actions)
[![Actions Status](https://github.com/gcasadesus/cspice/workflows/Ubuntu/badge.svg)](https://github.com/gcasadesus/cspice/actions)
[![Actions Status](https://github.com/gcasadesus/cspice/workflows/Style/badge.svg)](https://github.com/gcasadesus/cspice/actions)
[![Actions Status](https://github.com/gcasadesus/cspice/workflows/Install/badge.svg)](https://github.com/gcasadesus/cspice/actions)
[![codecov](https://codecov.io/gh/gcasadesus/cspice/branch/master/graph/badge.svg)](https://codecov.io/gh/gcasadesus/cspice)
...
- Code formatting enforced by [clang-format](https://clang.llvm.org/docs/ClangFormat.html) and [cmake-format](https://github.com/cheshirekow/cmake_format) via [Format.cmake](https://github.com/gcasadesus/Format.cmake)
- Reproducible dependency management via [CPM.cmake](https://github.com/gcasadesus/CPM.cmake)
- Installable target with automatic versioning information and header generation via [PackageProject.cmake](https://github.com/gcasadesus/PackageProject.cmake)
- Automatic [documentation](https://gcasadesus.github.io/cspice) and deployment with [Doxygen](https://www.doxygen.nl) and [GitHub Pages](https://pages.github.com)
...
- Replace all occurrences of "cspice" in the relevant CMakeLists.txt with the name of your project
  - Capitalization matters here: `cspice` means the name of the project, while `cspice` is used in file names.
  - Remember to rename the `include/cspice` directory to use your project's lowercase name and update all relevant `#include`s accordingly.
...
See [Format.cmake](https://github.com/gcasadesus/Format.cmake) for details.
...
The documentation is automatically built and [published](https://gcasadesus.github.io/cspice) whenever a [GitHub Release](https://help.github.com/en/github/administering-a-repository/managing-releases-in-a-repository) is created.
...
See [here](https://github.com/gcasadesus/StaticTypeInfo) for an example header-only library based on the template.
...
[CPM.cmake](https://github.com/gcasadesus/CPM.cmake) should be invisible to library users as it's a self-contained CMake Script.
...
Perhaps the [MiniCppStarter](https://github.com/gcasadesus/MiniCppStarter) is something for you!

## Related projects and alternatives

- [**cspice & PVS-Studio Static Code Analyzer**](https://github.com/viva64/pvs-studio-cmake-examples/tree/master/modern-cpp-starter): Official instructions on how to use the cspice with the PVS-Studio Static Code Analyzer.
...
[![Star History Chart](https://api.star-history.com/svg?repos=gcasadesus/cspice,cpp-best-practices/gui_starter_template,filipdutescu/modern-cpp-template&type=Date)](https://star-history.com/#gcasadesus/cspice&cpp-best-practices/gui_starter_template&filipdutescu/modern-cpp-template&Date)
